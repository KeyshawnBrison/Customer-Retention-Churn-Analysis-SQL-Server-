...
1. Load the cleaned dataset into SQL Server
2. Create a table named customer_data
3. Execute the SQL scripts in the / sql folder
4. Review resluts directly in SSMS

## Skills Demonstrated
- Intermediate to advance SQL
- Customer lifecycle analytics
- Cohort and churn modeling
- Business-Focused data interpretation

## Contact
Keyshawn Brison
Business & Marketing Analyst
brisonkeyshawn@yahoo.com
